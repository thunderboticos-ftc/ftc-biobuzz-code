...
@Autonomous
public class RedAutonomousCenter extends OpMode {
    ...
    private final Pose startPose = new Pose(9, 71.92523364485983, Math.toRadians(0));
    private final Pose shootPose = new Pose(59.813084112149525, 24, Math.toRadians(-90));
